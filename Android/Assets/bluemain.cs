...
public class bluemain : MonoBehaviourPunCallbacks
{
    ...
    void Stage_8()
    {
        ...
        photonView.RPC("Delete", RpcTarget.AllBuffered, transform.Find("Центр(R)").Find("del").GetComponent<PhotonView>().ViewID);
